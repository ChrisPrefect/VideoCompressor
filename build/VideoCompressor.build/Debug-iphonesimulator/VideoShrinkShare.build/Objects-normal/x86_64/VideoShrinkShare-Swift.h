...
#ifndef VIDEOSHRINKSHARE_SWIFT_H
#define VIDEOSHRINKSHARE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="VideoShrinkShare",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
/// iOS startet eine Subklasse von <code>UIViewController</code> als Entry-Point der
/// Share-Extension; wir hosten unsere SwiftUI-View darin.
SWIFT_CLASS("_TtC16VideoShrinkShare19ShareViewController")
